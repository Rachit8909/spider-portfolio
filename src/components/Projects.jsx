...
const MISSIONS = [
  {
    id: '01',
    name: 'Stamped',
    description: ' It is a platform where interns permanently preserve and verify their work experience — so it survives even when the company doesn',
  ...
  },
  {
    ...
    description: 'A personal finance tracker that helps you see exactly where your money goes — so you stop wondering and start controlling.',
  ...
  },
  {
    ...
    description: 'Where my code, curiosity, and ambition live on the internet.',
    tech: ['React', 'Github', 'Agentic IDE', 'vercel', 'Web3Forms'],
    image: imgSpiderman,
    link: '#',
