        ...
        >
          ...
          <div className="flex-1 max-w-lg lg:max-w-xl text-left">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-[1rem] xl:text-[3.5rem] font-bold tracking-tighter drop-shadow-2xl leading-[1.05] font-sans">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-500 font-serif italic font-light pr-2">Building </span>  Scalable<br />
              Web Applications
            </h1>
          </div>
          ...
          <div className=" flex-1 max-w-md text-left md:text-right flex flex-col md:items-end">
            <p className="w-110 text-lg md:text-xl text-gray-300 drop-shadow-xl font-light tracking-wide leading-relaxed mb-8">
              Focused on building modern web applications, strengthening problem-solving skills through Data Structures & Algorithms, and gaining hands-on experience with the MERN stack and AWS Cloud.



            </p>

            <a href="#projects" className="pointer-events-auto px-8 py-4 rounded-full border border-white/30 text-white text-sm tracking-[0.2em] uppercase font-medium hover:bg-white hover:text-black hover:border-white transition-all duration-500 backdrop-blur-sm shadow-xl inline-block text-center">
              Projects
            </a>
          </div>
