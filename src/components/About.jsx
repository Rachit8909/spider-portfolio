        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
              Every great application is built on two foundations: problem solving and user experience. I enjoy working at the intersection of both—strengthening my analytical thinking through Data Structures & Algorithms while building modern web applications with the MERN stack. From solving 300+ LeetCode problems to developing real-world projects and exploring AWS Cloud, I am continuously expanding my skills as a software engineer and learning how to turn ideas into reliable software.
